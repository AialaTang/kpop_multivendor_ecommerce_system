...
class Product(models.Model):
    ...
    pid=ShortUUIDField(unique=True, length=5,max_length=10, prefix="KP",alphabet="bcdefghijklmnopqrstuvwxyz")
...
class Gallery(models.Model):
   ...
   image=models.FileField(upload_to="product",default="product.jpg",null=True,blank=True)
   active=models.BooleanField(default=True)
   gid=ShortUUIDField(unique=True, length=5,max_length=10, prefix="KP",alphabet="bcdefghijklmnopqrstuvwxyz")
...
class CartOrder(models.Model):
   ...
   oid=ShortUUIDField(unique=True, length=10,max_length=12, prefix="KP",alphabet="bcdefghijklmnopqrstuvwxyz")
   date=models.DateTimeField(auto_now_add=True)
