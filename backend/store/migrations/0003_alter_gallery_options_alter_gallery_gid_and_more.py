# Generated by Django 4.2.7 on 2024-05-16 04:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('store', '0002_alter_product_pid_specification_size_gallery_color'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='gallery',
            name='gid',
            field=shortuuid.django_fields.ShortUUIDField(alphabet='bcdefghijklmnopqrstuvwxyz', length=10, max_length=10, prefix='KP', unique=True),
        ),
        migrations.AlterField(
            model_name='product',
            name='pid',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addredd', models.CharField(blank=True, max_length=100, null=True)),
                ('city', models.CharField(blank=True, max_length=100, null=True)),
                ('state', models.CharField(blank=True, max_length=100, null=True)),
                ('country', models.CharField(blank=True, max_length=100, null=True)),
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet='bcdefghijklmnopqrstuvwxyz', length=10, max_length=10, prefix='KP', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('shipping_amountl', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('service_fee', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('tax_fee', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('country', models.CharField(blank=True, max_length=100, null=True)),
