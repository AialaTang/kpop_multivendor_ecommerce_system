...
urlpatterns = [
    ...
    path('customer/notification/<int:user_id>/',customer_views.CustomerNotificationAPIView.as_view()),
    path('customer/notification/<int:user_id>/<int:noti_id>/',customer_views.MarkNotificationAsSeen.as_view()),
    ...
    path('vendor/order/filter/<vendor_id>',vendor_views.FilterOrderAPIView.as_view()),
    ...
    path('vendor/noti/filter/<vendor_id>',vendor_views.FilterNotificationAPIView.as_view()),
